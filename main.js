...
//form goinderildiginde addItem fonksiyonunu cagir
form.addEventListener("submit",addItem);
//temizle dugmesine  tiklandigi zaman clearItems fonksiyonunu cagirir
clearBtn.addEventListener("click",clearItems);
// sayfa yuklendiginde setupItems fonksiyonunu cagirir
...
setBackToDefault();
   ...
   displayAlert("degerr degistirildi", "success");
...
function deleteItem(e) {
   ...
   console.log(element);
   const id = element.dataset.id; //LocalStorage kullanilacak
...
// form degeri duzenlenen ogenin metniyle doldur
